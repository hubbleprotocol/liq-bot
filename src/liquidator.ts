import { DECIMAL_FACTOR, STABLECOIN_DECIMALS, DECIMALS_BTC, LAMPORTS_PER_MSOL, DECIMALS_RAY, DECIMALS_FTT, DECIMALS_ETH, DECIMALS_SRM } from "@hubbleprotocol/hubble-sdk";
...
export class Liquidator {
    ...
    constructor(cluster: Cluster, idl: Idl, configs: Array<Config>, clusterConfig: Config, wallet: Wallet, hubbleProgram: Program<Idl>, borrowingMarketState: BorrowingMarketState, liquidationsQueue: LiquidationsQueue) {
        ...
        this.pollingAccountsFetcher = new PollingAccountsFetcher(process.env.RPC_URL, 500, 5);
