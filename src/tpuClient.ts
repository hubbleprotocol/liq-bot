...
export class LeaderTpuService {
    ...
    leaderTpuSockets(fanout_slots: number): Promise<Array<string>> {
...
export class TpuConnection extends Connection {
    ...
    async sendAndConfirmRawTransaction(connection: TpuConnection, rawTransaction: Buffer | number[] | Uint8Array, options?: ConfirmOptions) : Promise<string> {
